# Here, ask your IT office for the code blocks for the header and footer of your website.
# We considered embedding the content as an iframe, but the changing size meant that they
# would have make the page extremely long by default. This makes the page feel more familiar
# to your users.

# We included our own code blocks for the convenience of internal users of this template, but
# be sure to replace it with your own content.
